<div
    ...
    <label>
        <input {{ $attributes->merge(['class' => 'block min-w-0 grow py-1.5 px-3 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6']) }}>
    </label>
</div>
